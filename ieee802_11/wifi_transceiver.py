...
class wifi_transceiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.pdu_length = pdu_length = 150
        self.lo_offset = lo_offset = 0
        self.interval = interval = 750
        ...
        self._tx_gain_range = qtgui.Range(0, 1, 0.01, 0.5, 200)
        ...
        self._pdu_length_range = qtgui.Range(0, 1500, 1, 150, 200)
        ...
        self._interval_range = qtgui.Range(10, 1000, 1, 750, 200)
        ...
        self.zeromq_push_sink_0 = zeromq.push_sink(gr.sizeof_gr_complex, 52, 'tcp://127.0.0.1:64000', 100, False, (-1), True)
        self.zeromq_pull_msg_source_0 = zeromq.pull_msg_source('tcp://127.0.0.1:64001', 100, False)
        ...
        self.qtgui_time_sink_x_1_0 = qtgui.time_sink_c(
            (52*1), #size
            samp_rate, #samp_rate
            "Channel State Information", #name
            1, #number of inputs
            None # parent
        )
        self.qtgui_time_sink_x_1_0.set_update_time(0.10)
        self.qtgui_time_sink_x_1_0.set_y_axis(-40, 80)
        ...
        labels = ['Real', 'Img', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.blocks_vector_to_stream_0 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, 52)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(0.6)
        self.blocks_multiply_const_vxx_0.set_min_output_buffer(100000)
        self.blocks_message_strobe_0_0 = blocks.message_strobe(pmt.intern("".join("P" for i in range(pdu_length))), interval)
        ...
        self.msg_connect((self.wifi_phy_hier_0, 'mac_out'), (self.ieee802_11_extract_csi_0, 'pdu in'))
        ...
        self.msg_connect((self.zeromq_pull_msg_source_0, 'out'), (self.ieee802_11_mac_0, 'app in'))
        ...
        self.connect((self.ieee802_11_extract_csi_0, 0), (self.blocks_vector_to_stream_0, 0))
        self.connect((self.ieee802_11_extract_csi_0, 0), (self.zeromq_push_sink_0, 0))
    ...
    def set_pdu_length(self, pdu_length):
        ...
        self.blocks_message_strobe_0_0.set_msg(pmt.intern("".join("P" for i in range(self.pdu_length))))
